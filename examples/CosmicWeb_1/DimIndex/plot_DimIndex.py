...
sc = ax.scatter(data_dimidx_original_1[:,0],data_dimidx_original_1[:,1],data_dimidx_original_1[:,2], s=0.1,color = "red")
sc = ax.scatter(data_dimidx_original_2[:,0],data_dimidx_original_2[:,1],data_dimidx_original_2[:,2], s=0.1,color = "blue")
sc = ax.scatter(data_dimidx_original_3[:,0],data_dimidx_original_3[:,1],data_dimidx_original_3[:,2], s=0.1,color = "magenta")
ax.view_init(44, 125)
...
sc = ax.scatter(data_dimidx_smoothed_1[:,0],data_dimidx_smoothed_1[:,1],data_dimidx_smoothed_1[:,2], s=0.1,color = "red")
sc = ax.scatter(data_dimidx_smoothed_2[:,0],data_dimidx_smoothed_2[:,1],data_dimidx_smoothed_2[:,2], s=0.1,color = "blue")
sc = ax.scatter(data_dimidx_smoothed_3[:,0],data_dimidx_smoothed_3[:,1],data_dimidx_smoothed_3[:,2], s=0.1,color = "magenta")
ax.view_init(44, 125)
